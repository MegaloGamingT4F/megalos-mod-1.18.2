...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> ANTIMONY_ORE = ConfiguredFeatures.register("antimony_ore", Feature.ORE, new OreFeatureConfig(ANTIMONY_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> ARSENIC_ORE = ConfiguredFeatures.register("arsenic_ore", Feature.ORE, new OreFeatureConfig(ARSENIC_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> BARIUM_ORE = ConfiguredFeatures.register("barium_ore", Feature.ORE, new OreFeatureConfig(BARIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> BERYLLIUM_ORE = ConfiguredFeatures.register("beryllium_ore", Feature.ORE, new OreFeatureConfig(BERYLLIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> BISMUTH_ORE = ConfiguredFeatures.register("bismuth_ore", Feature.ORE, new OreFeatureConfig(BISMUTH_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CADMIUM_ORE = ConfiguredFeatures.register("cadmium_ore", Feature.ORE, new OreFeatureConfig(CADMIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CAESIUM_ORE = ConfiguredFeatures.register("caesium_ore", Feature.ORE, new OreFeatureConfig(CAESIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CALCIUM_ORE = ConfiguredFeatures.register("calcium_ore", Feature.ORE, new OreFeatureConfig(CALCIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CHROMIUM_ORE = ConfiguredFeatures.register("chromium_ore", Feature.ORE, new OreFeatureConfig(CHROMIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> CINNABAR_ORE = ConfiguredFeatures.register("cinnabar_ore", Feature.ORE, new OreFeatureConfig(CINNABAR_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> COBALT_ORE = ConfiguredFeatures.register("cobalt_ore", Feature.ORE, new OreFeatureConfig(COBALT_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> GERMANIUM_ORE = ConfiguredFeatures.register("germanium_ore", Feature.ORE, new OreFeatureConfig(GERMANIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> GALLIUM_ORE = ConfiguredFeatures.register("gallium_ore", Feature.ORE, new OreFeatureConfig(GALLIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> HAFNIUM_ORE = ConfiguredFeatures.register("hafnium_ore", Feature.ORE, new OreFeatureConfig(HAFNIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> INDIUM_ORE = ConfiguredFeatures.register("indium_ore", Feature.ORE, new OreFeatureConfig(INDIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> IRIDIUM_ORE = ConfiguredFeatures.register("iridium_ore", Feature.ORE, new OreFeatureConfig(IRIDIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> LEAD_ORE = ConfiguredFeatures.register("lead_ore", Feature.ORE, new OreFeatureConfig(LEAD_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> LITHIUM_ORE = ConfiguredFeatures.register("lithium_ore", Feature.ORE, new OreFeatureConfig(LITHIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> MAGNESIUM_ORE = ConfiguredFeatures.register("magnesium_ore", Feature.ORE, new OreFeatureConfig(MAGNESIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> MANGANESE_ORE = ConfiguredFeatures.register("manganese_ore", Feature.ORE, new OreFeatureConfig(MANGANESE_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> MOLYBDENUM_ORE = ConfiguredFeatures.register("molybdenum_ore", Feature.ORE, new OreFeatureConfig(MOLYBDENUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NICKEL_ORE = ConfiguredFeatures.register("nickel_ore", Feature.ORE, new OreFeatureConfig(NICKEL_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> NIOBIUM_ORE = ConfiguredFeatures.register("niobium_ore", Feature.ORE, new OreFeatureConfig(NIOBIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> OSMIUM_ORE = ConfiguredFeatures.register("osmium_ore", Feature.ORE, new OreFeatureConfig(OSMIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> PALLADIUM_ORE = ConfiguredFeatures.register("palladium_ore", Feature.ORE, new OreFeatureConfig(PALLADIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> PHOSPHORUS_ORE = ConfiguredFeatures.register("phosphorus_ore", Feature.ORE, new OreFeatureConfig(PHOSPHORUS_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> PLATINUM_ORE = ConfiguredFeatures.register("platinum_ore", Feature.ORE, new OreFeatureConfig(PLATINUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> POTASSIUM_ORE = ConfiguredFeatures.register("potassium_ore", Feature.ORE, new OreFeatureConfig(POTASSIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RHENIUM_ORE = ConfiguredFeatures.register("rhenium_ore", Feature.ORE, new OreFeatureConfig(RHENIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RHODIUM_ORE = ConfiguredFeatures.register("rhodium_ore", Feature.ORE, new OreFeatureConfig(RHODIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RUBIDIUM_ORE = ConfiguredFeatures.register("rubidium_ore", Feature.ORE, new OreFeatureConfig(RUBIDIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> RUTHENIUM_ORE = ConfiguredFeatures.register("ruthenium_ore", Feature.ORE, new OreFeatureConfig(RUTHENIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> SCANDIUM_ORE = ConfiguredFeatures.register("scandium_ore", Feature.ORE, new OreFeatureConfig(SCANDIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> SELENIUM_ORE = ConfiguredFeatures.register("selenium_ore", Feature.ORE, new OreFeatureConfig(SELENIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> SILICON_ORE = ConfiguredFeatures.register("silicon_ore", Feature.ORE, new OreFeatureConfig(SILICON_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> SILVER_ORE = ConfiguredFeatures.register("silver_ore", Feature.ORE, new OreFeatureConfig(SILVER_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> SODIUM_ORE = ConfiguredFeatures.register("sodium_ore", Feature.ORE, new OreFeatureConfig(SODIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> STRONTIUM_ORE = ConfiguredFeatures.register("strontium_ore", Feature.ORE, new OreFeatureConfig(STRONTIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TANTALUM_ORE = ConfiguredFeatures.register("tantalum_ore", Feature.ORE, new OreFeatureConfig(TANTALUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TECHNETIUM_ORE = ConfiguredFeatures.register("technetium_ore", Feature.ORE, new OreFeatureConfig(TECHNETIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TELLURIUM_ORE = ConfiguredFeatures.register("tellurium_ore", Feature.ORE, new OreFeatureConfig(TELLURIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> THALLIUM_ORE = ConfiguredFeatures.register("thallium_ore", Feature.ORE, new OreFeatureConfig(THALLIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TIN_ORE = ConfiguredFeatures.register("tin_ore", Feature.ORE, new OreFeatureConfig(TIN_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TITANIUM_ORE = ConfiguredFeatures.register("titanium_ore", Feature.ORE, new OreFeatureConfig(TITANIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> TUNGSTEN_ORE = ConfiguredFeatures.register("tungsten_ore", Feature.ORE, new OreFeatureConfig(TUNGSTEN_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> VANADIUM_ORE = ConfiguredFeatures.register("vanadium_ore", Feature.ORE, new OreFeatureConfig(VANADIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> YTTRIUM_ORE = ConfiguredFeatures.register("yttrium_ore", Feature.ORE, new OreFeatureConfig(YTTRIUM_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> ZINC_ORE = ConfiguredFeatures.register("zinc_ore", Feature.ORE, new OreFeatureConfig(ZINC_ORES,9));
    public static final RegistryEntry<ConfiguredFeature<OreFeatureConfig, ?>> ZIRCONIUM_ORE = ConfiguredFeatures.register("zirconium_ore", Feature.ORE, new OreFeatureConfig(ZIRCONIUM_ORES,9));
