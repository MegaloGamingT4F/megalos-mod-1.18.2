...
import net.megalogaming.megalosmetallurgy.block.custom.MetallurgicFurnaceBlock;
import net.megalogaming.megalosmetallurgy.itemgroup.MegalosModItemGroup;
...
public class ModBlocks {
    ...
    //Technology
    public static final Block METALLURGIC_FURNACE = registerBlock("metallurgic_furnace", new MetallurgicFurnaceBlock(FabricBlockSettings.of(Material.METAL).nonOpaque()),MegalosModItemGroup.ALLOY);

    private static Block registerBlock(String name, Block block, ItemGroup group){
        registerBlockItem(name, block, group);
        return Registry.register(Registry.BLOCK, new Identifier(MegalosMetallurgy.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup group){
        return Registry.register(Registry.ITEM, new Identifier(MegalosMetallurgy.MOD_ID, name),
