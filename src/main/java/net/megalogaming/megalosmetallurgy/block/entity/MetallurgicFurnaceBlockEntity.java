...
import net.megalogaming.megalosmetallurgy.item.inventory.ImplementedInventory;
import net.megalogaming.megalosmetallurgy.recipe.MetallurgicFurnaceRecipe;
import net.megalogaming.megalosmetallurgy.screen.MetallurgicFurnaceScreenHandler;
...
public class MetallurgicFurnaceBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.literal("Metallurgic Furnace");
    }
