...
import net.megalogaming.megalosmetallurgy.item.tools.ModAxeItem;
import net.megalogaming.megalosmetallurgy.item.tools.ModHoeItem;
import net.megalogaming.megalosmetallurgy.item.tools.ModPickaxeItem;
import net.megalogaming.megalosmetallurgy.item.tools.ModShovelItem;
...
private static Item registerItem(String name, Item item){
    return Registry.register(Registry.ITEM, new Identifier(MegalosMetallurgy.MOD_ID, name), item);
}
