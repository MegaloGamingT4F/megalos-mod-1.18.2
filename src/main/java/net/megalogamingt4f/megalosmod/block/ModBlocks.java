...
public class ModBlocks {
    public static final Block ALUMINIUM_ORE = registerblock("aluminium_ore", new Block(FabricBlockSettings.of(Material.STONE).strength(4.5f).requiresTool()), ItemGroup.MISC);
